package com.lutty.translate.android.voiceToText.data
...
import com.lutty.translate.voiceToText.domain.VoiceToTextParserState
...
class AndroidVoiceToTextParser(
  ...
  override fun startListening(langCode: String) {
    ...
    if (!SpeechRecognizer.isRecognitionAvailable(app)) {
      _state.update { it.copy(error = app.getString(R.string.error_speech_recognition_not_available)) }
      return
    }
